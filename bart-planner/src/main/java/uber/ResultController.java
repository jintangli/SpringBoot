...
public class ResultController 
{
	...
	public String retrieveAndShow(@ModelAttribute Station selectedDestStation, Model model, HttpSession session, HttpServletRequest request)
	{
		System.out.println("********enter show result *********************");
		...
		String selectedStation = selectedDestStation.getAbbr();
